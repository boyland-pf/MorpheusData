...
savefile <- function(df, name) {
    rawname = paste("data-raw/", name, ".csv", sep='')
    write.csv(df, file = rawname,  row.names = FALSE)
    save(df, file = paste("data/", name, ".rdata", sep=''))
}
...
savefile(b4_input1, "b4_input1")
savefile(b4_output1, "b4_output1")
...
savefile(b5_input1, "b5_input1")
savefile(b5_output1, "b5_output1")
...
b7_output1 <- gather(b7_input1, variable, value, var1, var2, val) %>%
                    ...
                    spread(var, value)
savefile(b7_input1, "b7_input1")
savefile(b7_output1, "b7_output1")
...
savefile(b19_input1, "b19_input1")
savefile(b19_output1, "b19_output1")
...
savefile(b22_input1, "b22_input1")
savefile(b22_output1, "b22_output1")
...
savefile(b25_input1, "b25_input1")
savefile(b25_output1, "b25_output1")
...
b28_output1 <-  b28_input1 %>% gather(variable, value, -(month:student)) %>%
                ...
                spread(temp, value)
savefile(b28_input1, "b28_input1")
savefile(b28_output1, "b28_output1")
...
savefile(b29_input1, "b29_input1")
savefile(b29_output1, "b29_output1")
